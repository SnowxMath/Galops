          ...
          schemas: [
            {
              ...
              src: "/images/selle.png",
              points: [
                { label: "Pommeau", x: 33, y: 30 },
                { label: "Troussequin", x: 62, y: 22 },
                { label: "Siège", x: 48, y: 32 },
                { label: "Quartier", x: 64, y: 58 },
                { label: "Étrivière", x: 82, y: 46 },
                { label: "Étrier", x: 86, y: 61 },
                { label: "Sangle", x: 45, y: 82 },
              ],
            },
            {
              id: "filet",
              ...
              src: "/images/filet.png",
              points: [
                { label: "Têtière", x: 36, y: 16 },
                { label: "Frontal", x: 33, y: 22 },
                { label: "Montant", x: 34, y: 40 },
                { label: "Sous-gorge", x: 40, y: 45 },
                { label: "Muserolle", x: 22, y: 56 },
                { label: "Mors", x: 27, y: 70 },
                { label: "Rêne", x: 62, y: 63 },
              ],
            },
          ],
          ...
          schemas: [
            {
              ...
              src: "/images/cheval.png",
              points: [
                { label: "Tête", x: 22, y: 28 },
                { label: "Crinière", x: 34, y: 18 },
                { label: "Encolure", x: 33, y: 34 },
                { label: "Garrot", x: 45, y: 26 },
                { label: "Dos", x: 57, y: 31 },
                { label: "Rein", x: 66, y: 31 },
                { label: "Croupe", x: 74, y: 31 },
                { label: "Queue", x: 83, y: 42 },
                { label: "Épaule", x: 39, y: 45 },
                { label: "Poitrail", x: 33, y: 52 },
                { label: "Ventre", x: 57, y: 57 },
                { label: "Flanc", x: 68, y: 50 },
                { label: "Membre antérieur", x: 43, y: 75 },
                { label: "Membre postérieur", x: 74, y: 75 },
                { label: "Sabot", x: 43, y: 92 },
              ],
            },
            {
              id: "robes",
              type: "image",
              legende: "Les 3 robes de base",
              src: "/images/robes.png",
              points: [
                { label: "Noir", x: 18, y: 50 },
                { label: "Alezan", x: 49, y: 50 },
                { label: "Bai", x: 80, y: 50 },
              ],
            },
            {
              id: "allures",
              type: "image",
              legende: "Les 3 allures",
              src: "/images/allures.png",
              points: [
                { label: "Pas", x: 20, y: 48 },
                { label: "Trot", x: 49, y: 48 },
                { label: "Galop", x: 80, y: 50 },
              ],
            },
          ],
